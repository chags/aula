    ...
    <div class="col-sm-8">
        <form method="POST" action="model/usuario.php"  class="row g-3">
            <div class="col-12">
                    ...
                    <input type="text" name="area" class="form-control" id="inputAddress" placeholder="Digite a área do triangulo">
            </div>

            <div class="col-12">
                    <label for="inputAddress" class="form-label"><i class="fas fa-user-edit"></i>Digite a base do triangulo</label>
                    <input type="text" name="base" class="form-control" id="inputAddress" placeholder="Digite a base do triangulo">
            </div>
